...
* **Show axes:** Activates the display of the 3D anatomical axes (x, y, z).
* **Axis thickness:** `[1--12]` Adjust the line width of the displayed axes.
* **Show axis label:** Activates text labels for anatomical directions (Superior, Posterior, Anterior, Inferior, Right, Left).
