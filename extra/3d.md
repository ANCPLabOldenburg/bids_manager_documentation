...
* It requires GPU (integrated or discreted) for graphics smooth interaction. Check your Task Manager, usually in the _Performance_ window to check if your sytem counts with one. If your system doesn't count with one, the 3D View will remain empty.
