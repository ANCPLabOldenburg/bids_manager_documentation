...
* **Rendering Mode:** You can decide in-between `Point Cloud` or `Surface Mesh`, they have different adjustable parameters.
  * `Point Cloud`: Rendes visible scattered voxels as points. You can control the following visual parameters:
...
<img src="../static/3d/02_threshold.gif" alt="intro" width="600px">
   ...
   * `Surface Mesh`: extracts an iso-surface and displays it three dimensional triangles that connect points with similar values.
